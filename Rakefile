# from https://gist.github.com/SirRawlins/8684701
...
namespace :blog do
  ...
  task :publish do
    ...
    Jekyll::Site.new(Jekyll.configuration({
      "source"      => ".",
      "destination" => "/home/alexforsale/public_html/blog/",
      "config" => "_config.yml"
    })).process

    # Get the origin to which we are going to push the site.
    origin = `git config --get remote.alexforsale.url`
    ...
    Dir.mktmpdir do |tmp|
      ...
      cp_r "/home/alexforsale/public_html/blog/.", tmp
