...
Modifikasi awal yang saya lakukan adalah [memodifikasi file `/etc/fstab`]({{ site.baseurl }}{% post_url 2017-01-22-modifikasi-fstab-linux%}), [setup lagi jekyll dan apache](/post/2017-01-21-jekyll-dan-apache) untuk keperluan blog ini (bisa dibilang tampilan di *localhost* sebagai soft publish untuk mengecek hasil akhir).
