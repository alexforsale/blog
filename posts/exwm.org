...
*** Variables
    ...
    - persp-state-default-file :: The file location for =persp-state-save= and =persp-state-load=. The variable declaration is wrapped inside a function to guard in case =+emacs-data-dir= is unbound (this is a custom variable from my /Emacs/ [[file:../blog/posts/Emacs-Configuration.org::*Set /+emacs-data-dir/ variables.][configuration]]).
...
** gpg
   ...
   #+end_src
   This is for using /pinentry/ inside /Emacs/.
** Desktop Environment
   #+begin_src emacs-lisp
...
* Screenshots
  ...
  #+attr_org: :width 300
  #+ATTR_HTML: :class center no-border :width 75% :height 75%
  [[file:../blog/images/posts/exwm-with-emacs-config.png][../../images/posts/exwm-with-emacs-config.png]]
