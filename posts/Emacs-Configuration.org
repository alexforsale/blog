...
**** centaur-tabs
     ...
     #+begin_src emacs-lisp
       ...
       (defun centaur-tabs-buffer-groups ()
         ...
         (list
          (cond
           ;; set `Web' first to avoid mixing some buffer with
           ;; `Emacs' group
           ((or (string-equal exwm-class-name "firefox")
                (string-equal exwm-class-name "Nyxt")
                (string-equal (buffer-name) "*eww*"))
            "Web")
           ((or (memq major-mode '(vterm-mode
                                   eshell-mode
                                   term-mode))
                (string-equal exwm-class-name "XTerm")
                (string-equal exwm-class-name "Termite"))
            "Term")
