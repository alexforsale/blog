...
** helper functions and macros
   #+begin_src emacs-lisp
     (defmacro +config-load (var code)
       (when (bound-and-true-p var)
         `(require ,code)))
   #+end_src
** footer
   #+begin_src emacs-lisp
...
**** packages
     ...
     #+end_src
**** set =message-directory=
     This is the directory from which all other mail file variables are derived.
     #+begin_src emacs-lisp
...
**** sign outgoing mail by default
     Adds MML tag to encrypt/sign the entire message.
     #+begin_src emacs-lisp
       (require 'notmuch)
...
** exwm
   ...
   :END:
   #+begin_src emacs-lisp
     ;;; config-exwm.el --- Summary -*- lexical-binding: t -*-
     ;;; Commentary:
     ;; This file is auto-generated from `config.org'
     ;; See `https://java281.dynv6.net/~alexforsale/posts/Emacs-Configuration.html'
     ;;; Code:
       ...
       #+begin_src emacs-lisp
         (defun +config/exwm-init-hook ()
           (with-eval-after-load 'perspective
             ...
             (when (executable-find "unclutter")
