...
*** indentation
    #+begin_src emacs-lisp
      ...
      (customize-set-variable 'sh-indent-for-done 2)
      (customize-set-variable 'sh-indent-for-fi 2)
      (customize-set-variable 'sh-indent-for-else 2)
...
***** Set title for which-key
      #+begin_src emacs-lisp
        (+config/leader-def
          ...
          ":" 'eval-expression
          "B" '(:ignore t :which-key "Perspective Prefix")
